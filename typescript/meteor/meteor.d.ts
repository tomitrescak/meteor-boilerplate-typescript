...
declare module Meteor {
  ...
  interface Tinytest {
    ...
    addAsync(name:string, func:Function):void;
  }
...
declare module Mongo {
  ...
  interface AllowDenyOptions {
    ...
    update?: (userId:string, doc:Object, fieldNames:Object, modifier:Object) => boolean;
...
declare module DDP {
  interface DDPStatic {
    subscribe(name:string, ...rest:any[]):any;
...
declare
var IterationCallback:<T>(doc:T, index:number, cursor:Mongo.Cursor<T>) => void;
...
declare
var CompileStep:CompileStepStatic;
...
declare
var PackageAPI:PackageAPIStatic;
...
declare
var Subscription:SubscriptionStatic;
